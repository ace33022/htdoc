...
(function(root) { 
	...
	if (typeof define == 'function') {
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.po.Ancestor == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.po.Ancestor"] + '.js');
		}
		...
		root.tw.ace33022.po.FutureLargeStayAllLog = result;
	}
})(this);