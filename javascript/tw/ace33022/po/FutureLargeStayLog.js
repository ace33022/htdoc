...
(function(root) { 
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.po.FutureLargeStayAllLog", "underscore"], function(Ancestor) {
		...
		ancestor = require(RequireJSConfig.paths["tw.ace33022.po.FutureLargeStayAllLog"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.po.FutureLargeStayAllLog == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.po.FutureLargeStayAllLog"] + '.js');
		}
			
		_ = root._;
			
		ancestor = root.tw.ace33022.po.FutureLargeStayAllLog;
			
		root.tw.ace33022.po.FutureLargeStayLog = result;
	}
})(this);