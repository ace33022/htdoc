...
(function(root) {
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.po.Ancestor", "underscore"], function(Ancestor) {
		...
		ancestor = require(RequireJSConfig.paths["tw.ace33022.po.Ancestor"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.Ancestor == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.po.Ancestor"] + '.js');
		}
		
		_ = root._;
			
		ancestor = root.tw.ace33022.po.Ancestor;
		
		root.tw.ace33022.po.ForeignFutureDayTrnLog = result;
	}
})(this);