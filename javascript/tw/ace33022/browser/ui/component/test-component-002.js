 ...
 *
 */
class TestComponent002 extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
			...
			<span>使用test-component-002</span>
			<!-- <div>使用template</div> -->
    `;
	}
}

customElements.define('test-component-002', TestComponent002);