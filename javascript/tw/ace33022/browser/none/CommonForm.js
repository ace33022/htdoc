...
(function(root) {
	...
	define(["jquery", "underscore"], function() {
		 ...
		 *
		 * @todo 2025/01/09 ace 不使用jQuery元件的處理方式？
		 *
		 */
		var showMarqueebar = function(setting) {

			var tag = '<div class="ace-modal">'
							+ '  <div class="ace-modal-content">'
							+ '    <div class="ace-loader"></div>'
							+ '  </div>'
							+ '</div>';
			var modal = jQuery(tag);
			...
			if (typeof setting["onShownCallback"] == 'function') setting["onShownCallback"](function() {
