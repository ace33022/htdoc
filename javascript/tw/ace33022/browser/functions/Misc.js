...
(function(root) {
	...
	if (typeof define == 'function') {
		...
		module.exports.logEnvironmentSetting = logEnvironmentSetting;
	}
	else {
	
		root.tw.ace33022.browser.functions.Misc = {};
		
		root.tw.ace33022.browser.functions.Misc.rgb2hex = rgb2hex;
		root.tw.ace33022.browser.functions.Misc.getURLParameter = getURLParameter;
		root.tw.ace33022.browser.functions.Misc.removeHTMLTag = removeHTMLTag;
