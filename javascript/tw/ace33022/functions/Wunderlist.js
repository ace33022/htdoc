...
(function(root) {
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.functions.Wunderlist.getLists = getLists;
		root.tw.ace33022.functions.Wunderlist.postTasks = postTasks;
		root.tw.ace33022.functions.Wunderlist.getTasksByListId = getTasksByListId;
		root.tw.ace33022.functions.Wunderlist.getTasks = getTasks;
		root.tw.ace33022.functions.Wunderlist.patchTasks = patchTasks;
		root.tw.ace33022.functions.Wunderlist.deleteTasks = deleteTasks;
		root.tw.ace33022.functions.Wunderlist.postSubtasks = postSubtasks;
		root.tw.ace33022.functions.Wunderlist.getSubtasks = getSubtasks;
		root.tw.ace33022.functions.Wunderlist.patchSubtasks = patchSubtasks;
		root.tw.ace33022.functions.Wunderlist.postNotes = postNotes;
		root.tw.ace33022.functions.Wunderlist.getNotes = getNotes;
	}
})(this);