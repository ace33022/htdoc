		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			if ((result.location.protocol == 'chrome-extension:') || (result.location.protocol == 'file:')) {
				...
				if ('serviceWorker' in navigator) {
					...
					if (result.registerServiceWorker() == 'Y') navigator.serviceWorker.register(location.origin + location.pathname + 'service_worker.js').then(function(reg) {console.log('register complete.');}).catch(function(error) {console.log('register is error.');})
				} 
