...
(function(root) {
	...
	var result = function(conn) {
		...
		this.doDeleteByTrnDateAndProductCode = function(trnDate, productCode) {
		
			return this.getDAO().doDeleteByTrnDateAndProductCode(new Packages.java.lang.String(trnDate), new Packages.java.lang.String(productCode));
		}
